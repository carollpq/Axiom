...
import { InviteClaimClient } from '@/src/features/researcher/components/contract/invite-claim.client';
    ...
    return (
      ...
      >
        <div className="max-w-md w-full mx-auto px-6 text-center">
          <div className="text-[#d4645a] text-lg mb-2">
            {'\u2715'} Invalid or Expired Invite
          </div>
          <p className="text-[13px] text-[#6a6050] mb-6">
            This invite link is no longer valid. It may have expired (links are
            valid for 7 days) or already been used.
          </p>
          <Link
            href="/"
      ...
      <div className="max-w-lg w-full mx-auto px-6 py-12">
        ...
        <div className="mb-6">
          <div className="text-[10px] text-[#6a6050] uppercase tracking-[1.5px] mb-2">
            Authorship Contract Invite
          </div>
          <h1 className="text-[22px] font-normal text-[#e8e0d4] font-serif">
            {contract.paperTitle}
          </h1>
        </div>
        ...
        >
          <div className="text-[10px] text-[#6a6050] uppercase tracking-[1.2px] mb-3">
            Your Contribution
          </div>
          <div className="grid grid-cols-3 gap-4">
            <div>
              <div className="text-[10px] text-[#5a5040] mb-0.5">Wallet</div>
              <div className="text-[11px] text-[#5a7a9a] font-mono break-all">
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            {contract.contributors.map((c) => (
              <div
                key={c.contributorWallet}
                className="flex justify-between items-center"
              >
                <div className="text-[11px] text-[#8a8070] font-mono">
                  {c.contributorWallet.slice(0, 10)}…
                  {c.contributorWallet.slice(-6)}
                </div>
