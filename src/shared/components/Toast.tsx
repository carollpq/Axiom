...
const variantStyles: Record<ToastVariant, { bg: string; border: string; color: string }> = {
  success: { bg: "rgba(120,180,120,0.15)", border: "1px solid rgba(120,180,120,0.4)", color: "#8fbc8f" },
  error: { bg: "rgba(200,100,90,0.15)", border: "1px solid rgba(200,100,90,0.4)", color: "#d4645a" },
};
