  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          border: error
            ? '1px solid rgba(212,100,90,0.4)'
            : '2px dashed rgba(120,110,95,0.25)',
        ...
        {fileName ? (
          <div className="flex justify-between items-center">
            <div className="text-left">
              ...
              {isHashing ? (
                <div className="text-[10px] text-[#c9a44a] font-mono mt-1">
          ...
          <div>
            ...
            <div className="text-[10px] text-[#4a4238] mt-1">
              A unique digital fingerprint is generated locally — your file
