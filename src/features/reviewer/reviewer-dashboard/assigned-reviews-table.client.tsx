...
export function AssignedReviewsTable({
  reviews,
  hoveredRow,
  onHoverRow,
  getUrgencyStyle,
  ...
  return (
    ...
    >
      ...
      {reviews.map((r, i) => {
        ...
        const reviewUrl = `/reviewer/assigned`;
        return (
          <div
            key={r.id}
            ...
            style={{
              ...
              gridTemplateColumns: '2.5fr 1fr 0.8fr 0.8fr 0.8fr 0.7fr',
              background:
                hoveredRow === r.id ? 'rgba(120,110,95,0.08)' : 'transparent',
              borderBottom:
                i < reviews.length - 1
          ...
          >
            ...
            <span
              ...
              style={{
                color: u.color,
                fontWeight: r.status === 'Late' ? 600 : 400,
              }}
            >
              {r.status === 'Late'
            ...
            <span>
              {r.status !== 'Submitted' && (
                <a
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, rgba(180,160,120,0.2), rgba(160,140,100,0.12))',
