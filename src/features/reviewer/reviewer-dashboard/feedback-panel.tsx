    ...
    <div>
      ...
      >
        ...
        <div className="flex gap-8 items-center flex-wrap">
          <div>
            <div className="text-[11px] text-[#6a6050] mb-1">
              Overall Average
            </div>
          ...
          <div>
            ...
            <span className="text-[20px] font-serif text-[#e8e0d4]">
              {feedbackItems.length}
            </span>
          </div>
          <div className="text-[10px] text-[#4a4238] italic max-w-[300px]">
            All feedback is anonymous. You cannot identify which author provided
            a rating.
          </div>
        </div>
      </div>
                ...
                <div className="grid grid-cols-5 gap-2 mb-2">
                  {Object.entries(f.protocols).map(([key, val]) => (
                    <div key={key} className="text-center">
                      ...
                      <div className="text-[14px] font-serif text-[#c9a44a]">
                        {val}/5
                      </div>
                    </div>
                  ))}
