...
export function CompletedReviewSidebar({ paper }: CompletedReviewSidebarProps) {
  return (
    <div className="space-y-0">
      {/* Meta info */}
      <div className="p-4 space-y-3" style={{ borderBottom: "1px solid rgba(120,110,95,0.12)" }}>
        <div>
          <div className="text-[10px] uppercase tracking-[1.5px] mb-1" style={{ color: "#6a6050" }}>
            Journal
          </div>
        ...
        <CollapsibleSection title="Your Review" defaultOpen>
          <div className="space-y-3">
            {paper.reviewContent.strengths && (
              <div>
                <div className="text-[10px] uppercase tracking-wider mb-1" style={{ color: "#6a6050" }}>
                  Strengths
                </div>
                <div className="text-[12px] leading-relaxed" style={{ color: "#b0a898" }}>
                  {paper.reviewContent.strengths}
                </div>
              </div>
            )}
      ...
      {/* Author Response */}
      <CollapsibleSection title="Author Response" defaultOpen={!!paper.rebuttal}>
        <div className="space-y-3">
            ...
            <div className="space-y-3 mt-2">
              <div>
                ...
                <span
                  ...
                  style={{ backgroundColor: "rgba(90,122,154,0.2)", color: "#5a7a9a" }}
                >
              ...
              {paper.rebuttal.responseForThisReview && (
                <div>
                  ...
                  <div className="text-[12px] leading-relaxed mt-1" style={{ color: "#b0a898" }}>
              ...
              {paper.rebuttal.resolution && (
                <div>
                  ...
                  {paper.rebuttal.editorNotes && (
                    <div className="text-[12px] leading-relaxed mt-2" style={{ color: "#b0a898" }}>
                      {paper.rebuttal.editorNotes}
                    </div>
                  )}
                </div>
