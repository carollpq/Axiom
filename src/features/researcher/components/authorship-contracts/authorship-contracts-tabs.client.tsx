...
const ContractBuilder = dynamic(
  () =>
    import('@/src/features/researcher/components/contract/contract-builder.client'),
  {
    loading: () => (
...
const ContractsToSign = dynamic(() => import('./contracts-to-sign.client'), {
  loading: () => (
    <div className="p-6 text-[13px] text-[#6a6050]">Loading contracts...</div>
  ),
});
