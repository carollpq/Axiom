...
export function InviteModal({ isOpen, inviteLink, onClose }: InviteModalProps) {
  return (
    <ModalOverlay isOpen={isOpen} onClose={onClose}>
      <div className="text-base text-[#e8e0d4] italic mb-3">
        Invite Off-Platform Contributor
      </div>
      <div className="text-xs text-[#8a8070] mb-4 leading-relaxed">
        Share this link with your collaborator. They will be prompted to connect
        a wallet and sign the contract.
      </div>
      <div
      ...
      >
        <span className="flex-1 text-xs text-[#5a7a9a] font-mono overflow-hidden text-ellipsis">
          {inviteLink}
        </span>
        <button
