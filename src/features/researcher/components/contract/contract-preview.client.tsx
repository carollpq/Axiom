  ...
  return (
    <>
      ...
      >
        ...
        <div className="px-6 pb-6">
          ...
          >
            ...
            {contributors.map((c, i) => (
              ...
              >
                <div>
                  ...
                  <span className="text-[11px] text-[#6a6050] ml-2">
                    {c.role}
                  </span>
                </div>
                <span className="text-[15px] text-[#c9b89e] font-sans font-semibold">
                  {c.pct}%
                </span>
              </div>
            ))}
            ...
            >
              All parties agree to the contribution split as defined above. Any
              modification to authorship order or contribution weights requires
              unanimous re-signing by all contributors. This contract is
          ...
          <div className="mt-4 text-right">
            {!contractId && !submitted ? (
              ...
              <div>
                <div className="text-sm text-[#8fbc8f] mb-1">
                  {'\u2713'} Paper Submitted
                </div>
                <div className="text-[11px] text-[#6a6050]">
                  Your paper has been submitted to the journal and is awaiting
                  review.
                </div>
              </div>
            ) : allSigned ? (
              <div>
                ...
                <div className="text-[11px] text-[#6a6050] mb-4">
                  Recorded immutably on Hedera. You may now proceed to
                  submission.
                </div>
                {error && (
                  <div className="text-[11px] text-[#d4645a] mb-3">{error}</div>
                )}
                <button
      ...
      <ModalOverlay
        ...
        maxWidth="448px"
      >
        <h2 className="text-[16px] text-[#e8e0d4] font-serif mb-1">
          Select a Journal
        </h2>
        <p className="text-[11px] text-[#6a6050] mb-4">
          Choose the journal to submit your paper to.
        </p>

        {journals.length === 0 ? (
          <div className="text-[12px] text-[#6a6050] py-4 text-center">
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            ...
            style={{
              ...
              cursor:
                selectedJournalId && !submitting ? 'pointer' : 'not-allowed',
            }}
          >
