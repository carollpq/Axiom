...
const PROTOCOL_LABELS = [
  { key: "actionableFeedback", label: "The review provides clear, actionable feedback." },
  { key: "fairObjective", label: "The review was fair and objective." },
  { key: "deepEngagement", label: "The reviewer demonstrated deep engagement with the manuscript." },
  { key: "justifiedRecommendation", label: "The recommendation was clearly justified." },
  { key: "appropriateExpertise", label: "The reviewer demonstrated appropriate expertise." },
] as const;
