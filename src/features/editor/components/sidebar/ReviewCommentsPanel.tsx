            ...
            {expandedId === r.id && r.reviewContent && (
              ...
              >
                {r.reviewContent.strengths && (
                  <div>
                    <div className="text-[9px] text-[#6a6050] uppercase tracking-[1px] mb-0.5">Strengths</div>
                    <p className="text-[11px] text-[#b0a898] leading-relaxed">{r.reviewContent.strengths}</p>
                  </div>
                )}
                {r.reviewContent.weaknesses && (
                  <div>
                    <div className="text-[9px] text-[#6a6050] uppercase tracking-[1px] mb-0.5">Weaknesses</div>
                    <p className="text-[11px] text-[#b0a898] leading-relaxed">{r.reviewContent.weaknesses}</p>
                  </div>
                )}
                {r.reviewContent.recommendation && (
                  <div>
                    <div className="text-[9px] text-[#6a6050] uppercase tracking-[1px] mb-0.5">Recommendation</div>
                    <p className="text-[11px] text-[#b0a898] leading-relaxed">{r.reviewContent.recommendation}</p>
                  </div>
                )}
                {!r.reviewContent.strengths && !r.reviewContent.weaknesses && !r.reviewContent.recommendation && (
                  <p className="text-[11px] text-[#6a6050] italic">No detailed comments available.</p>
                )}
              </div>
            )}
          </div>
