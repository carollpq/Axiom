...
**Stack:** Next.js 16 (App Router, Turbopack) · React 19.2 · Tailwind CSS v4 · Thirdweb v5 · TypeScript strict · Neon PostgreSQL/Drizzle ORM · Hedera SDK (HCS + HTS + Smart Contracts + Mirror Node + Scheduled Transactions) · ethers v6 · Lit Protocol SDK · web3.storage (IPFS) · react-pdf v10
...
# Optional
CRON_SECRET, W3_PRINCIPAL_KEY, W3_DELEGATION_PROOF, NEXT_PUBLIC_LIT_NETWORK
```
